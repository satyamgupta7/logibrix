...
export const metadata: Metadata = {
  title: "Blog | LogiBrix Solutions Pvt Ltd",
  description:
    "Read the latest insights, updates, and expert opinions from LogiBrix – a leading SaaS platform powering modern logistics and supply chain innovation.",
  keywords: [
    "LogiBrix",
    "Logistics SaaS",
    "Supply Chain",
  ...
  openGraph: {
    title: "Blog Details | LogiBrix",
    description:
      "Explore expert-written blogs on logistics innovation, digital transformation, and industry trends.",
    url: "https://logibrix.in/blog",
    siteName: "LogiBrix",
    type: "article",
  },
  twitter: {
    title: "Blog Details | LogiBrix",
    description:
      "Discover insights from the LogiBrix team on smart logistics and digital supply chains.",
