        ...
        <div className="mb-12 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="mb-6 inline-flex items-center space-x-2">
              <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 text-sm font-bold text-white">
                LB
              </span>
              <span className="text-xl font-bold">
                Logi<span className="text-blue-400">Brix</span>
              </span>
            </Link>
            <p className="mb-6 max-w-md leading-relaxed text-gray-300">
              Transforming businesses with cutting-edge web solutions. We
              deliver premium digital experiences that drive growth and success.
            </p>
            <div className="flex space-x-4">
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/logibrix.in/"
                target="_blank"
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col items-center justify-between md:flex-row">
            <p className="text-sm text-gray-400">
              © {currentYear} LogiBrix. All rights reserved.
            </p>
