        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                <Link
                  href="/"
                  className="mb-8 inline-flex items-center space-x-2"
                >
                  <span className="flex h-10 w-10 items-center justify-center rounded-md bg-blue-600 text-sm font-semibold text-white dark:bg-blue-400 dark:text-gray-900">
                    LB
                  </span>
                ...
                <p className="text-body-color dark:text-body-color-dark mb-9 text-base leading-relaxed">
                  Custom web and software solutions for small and medium
                  businesses. Helping you grow with clean design, robust code,
          ...
          <div className="py-8">
            <p className="text-body-color text-center text-base dark:text-white">
              ©2025 All Rights Reserved by LogiBrix.
            </p>
          </div>
        </div>
